	...
	<div class="container mt-2">
		...
		<div class="container p-5 my-5 border">
			...
			<form action="pollProc.jsp" class="p-3"
				...
				<button type="button" class="btn btn-light mt-5"
					data-bs-toggle="modal" data-bs-target="#Result">결과</button>
				<button type="button" class="btn btn-light mt-5"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title" style="color:black;">투표 결과</h4>
...
<div class="modal" id="Delete">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal Header -->
			<div class="modal-header">
				<h4 class="modal-title" style="color:black;">투표 삭제</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
			</div>
			...
			<!-- Modal footer -->
			<div class="modal-footer">
				<button type="button" class="btn btn-danger" data-bs-dismiss="modal" herf="<%=root%>/pollDelete.jsp">Delete</button>
			</div>
